...
Gem::Specification.new do |spec|
  spec.name          = "peatio-mousecoin"
  spec.version       = Peatio::Mousecoin::VERSION
  spec.authors       = ["Bob Pepers"]
  spec.email         = ["support@runebase.io"]

  spec.summary       = %q{Gem for extending Peatio plugable system with Mousecoin implementation.}
  spec.description   = %q{Mousecoin Peatio gem which implements Peatio::Blockchain::Abstract & Peatio::Wallet::Abstract.}
