RSpec.describe Peatio::Mousecoin::Wallet do
  let(:wallet) { Peatio::Mousecoin::Wallet.new }
  ...
  context :configure do
    let(:unconfigured_wallet) { Peatio::Mousecoin::Wallet.new }
    ...
    it 'sets settings attribute' do
      ...
      expect(unconfigured_wallet.settings).to eq(settings.slice(*Peatio::Mousecoin::Wallet::SUPPORTED_SETTINGS))
    end
  end
